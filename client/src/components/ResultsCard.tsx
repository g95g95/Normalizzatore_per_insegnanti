    ...
    return (
      <div className="card">
        <div className="text-center py-12 text-slate-400">
          ...
          <p>Enter class grades and a student score to see the normalized result</p>
        </div>
      </div>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="stat-box">
            <div className="stat-label">Mean (/{sourceScale})</div>
          ...
          {details.q !== undefined && (
            <div className="stat-box">
              <div className="stat-label">Quantile (q)</div>
              <div className="stat-value">{formatNumber(details.q, 3)}</div>
            </div>
          )}
          {details.s !== undefined && (
            <div className="stat-box">
              <div className="stat-label">Tanh (s)</div>
              <div className="stat-value">{formatNumber(details.s, 3)}</div>
            </div>
          )}
          <div className="stat-box">
            <div className="stat-label">Raw Grade</div>
        ...
        <div className="bg-slate-700/30 rounded-lg p-4">
          <h3 className="text-sm font-medium text-slate-300 mb-2">How we got here:</h3>
